...
export default props => {
  return (
    <Content {...props}>
      ...
      <p>
        Here is an example of when we animate the CSS property
        {' '}
        <q>transform</q>
        {' '}
        by changing translateY:
      </p>
      ...
      <p>
        Here is a CSS animation. It is not bad! This CSS excerpt forces the browser to create a composited layer for an element when the page loads. When a user hovers, the browser does not have to perform a layout or paint operation and can animate the change in
        {' '}
        <q>transform</q>
        {' '}
        smoothly.
  ...
  &:hover {
    transform: translateY(-32px);
      ...
      <p>
        Animating these arguments of
        {' '}
        <q>transform</q>
        {' '}
        will only invalidate graphic layers and trigger page compositing:
      </p>
